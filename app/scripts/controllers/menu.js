    ...
    $scope.about = function () {
      var content = [
        ...
        '    <ul style="list-style:none;margin:10px;padding:0;">',
                    '<li><strong>Jesús Arroyo Torrens</strong> @jesus89 (creator)</li>',
        '           <li><strong>Carlos Venegas</strong> @cavacearr      (concepts and development)</li>',
        '           <li><strong>Juan González</strong> @Obijuan_cube         (concepts and testing)</li>',
            '</ul>',
        ...
        '    <p style="margin-top:30px;text-align:right;"><span class="copyleft">&copy;</span> FPGAwars 2016-2019</p>',
        '  </div>',
        '</div>'].join('\n');
