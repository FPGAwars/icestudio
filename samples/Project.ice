  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "a00e3e07-c233-4726-a912-1c3be184d517",
          "type": "basic.constant",
          "data": {
            "name": "N",
            "value": "22",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "The LED has <strong>three modes</strong> of operation:\nblinking, turned on and turned off\n<ul>\n<li>SW2 pushbutton determines if the<br>LED blinks/stays fixed</li>\n<li>SW1 pushbutton determines the LED<br>state (on or off), in fixed mode</li>\n</ul>",
            "readonly": true
          },
          "position": {
            "x": 632,
        ...
        {
          "id": "bffe1fe4-69da-4871-a95f-9a0dd853ebd0",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "a00e3e07-c233-4726-a912-1c3be184d517",
            "port": "constant-out"
          },
          "target": {
            "block": "bffe1fe4-69da-4871-a95f-9a0dd853ebd0",
